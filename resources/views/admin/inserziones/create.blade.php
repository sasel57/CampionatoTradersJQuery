...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.inserziones.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('broker') ? 'is-invalid' : '' }}" type="text" name="broker" id="broker" value="{{ old('broker', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fondo_iniziale') ? 'is-invalid' : '' }}" type="number" name="fondo_iniziale" id="fondo_iniziale" value="{{ old('fondo_iniziale', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fondo_finale') ? 'is-invalid' : '' }}" type="number" name="fondo_finale" id="fondo_finale" value="{{ old('fondo_finale', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('percentage') ? 'is-invalid' : '' }}" type="number" name="percentage" id="percentage" value="{{ old('percentage', '') }}" step="0.01" required>
