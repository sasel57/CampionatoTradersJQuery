    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.inserziones.update", [$inserzione->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="broker" id="broker" value="{{ old('broker', $inserzione->broker) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="fondo_iniziale" id="fondo_iniziale" value="{{ old('fondo_iniziale', $inserzione->fondo_iniziale) }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="fondo_finale" id="fondo_finale" value="{{ old('fondo_finale', $inserzione->fondo_finale) }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="percentage" id="percentage" value="{{ old('percentage', $inserzione->percentage) }}" step="0.01" required>
